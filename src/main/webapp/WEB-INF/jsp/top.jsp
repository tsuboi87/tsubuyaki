...
<%@ page import="cc.shinbi.tsubuyaki.model.Pair"%>
<%@ page import="cc.shinbi.tsubuyaki.model.entity.User"%>
<%@ page import="cc.shinbi.tsubuyaki.model.entity.Message"%>
<%
...
<body>
	...
	<main>
		<div>
			<a href="javascript:toggleNewMessage()"> <span
				id="new_message_icon" class="icon far fa-plus-square"></span>
			</a>
		</div>
		<div id="new_message_area">
			<form id="new_message_form" method="post" action="postMessage"
				...
				<div>
					...
					<a href="javascript:removeImage()"> <span
						class="icon red fas fa-times-circle"></span>
					</a>
				</div>
				<div>
			...
			<form id="message_operation_form" method="post" action="message">
				<input id="id_input" type="hidden" name="id" value=""> <input
					id="operation_input" type="hidden" name="operation" value="">
			</form>
		</div>
		<%
		if (error != null) {
...
%>
			<div class="tsubuyaki_icons">
				...
				%>
				<a href="javascript:editMessage(<%=message.getId()%>)"> <span
					class="icon fas fa-pencil-alt"></span>
				</a>
				<%
				}
				if (user.getId() == loginUser.getId() || loginUser.isAdmin()) {
				%>
				<a href="javascript:deleteMessage(<%=message.getId()%>)"> <span
					class="icon far fa-trash-alt"></span>
				</a>
				<%
}
%>
